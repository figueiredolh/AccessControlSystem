...
const visitante = require('./src/controllers/visitanteController');
...
route.post('/horarios/register', logado, horario.postCriarHorario);
route.get('/horarios/edit/:id', logado, horario.getEditHorario);
